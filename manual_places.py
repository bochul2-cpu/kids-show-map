...
MANUAL_PLACES = [
    ...
    # 2026-08-29 추가 - "아이랑 가볼만한곳" 블로그/카드뉴스 대조 2차 발견분 중
    # TourAPI에 아예 등록이 없고(확인함) NAVER에만 있는 것들
    {
        "id": "manual_gapcheon_eco_park",
        "type": "place",
        "category": "나들이·산책",
        "genre": "공원",
        "is_child": True,
        ...
        "schedule": "",
        "poster": "",
        "link": "https://www.daejeon.go.kr/glPark/index.do",
        "telephone": "",
        "approx_location": False,
        "amenities": [],
    },
    {
        "id": "manual_paju_nolgureum",
        "type": "place",
        "category": "체험·놀이",
        "genre": "실내테마파크",
        "is_child": True,
        ...
        "schedule": "",
        "poster": "",
        "link": "https://tickets.interpark.com/goods/21006636",
        "telephone": "",
        "approx_location": False,
        "amenities": [],
    },
    {
        "id": "manual_yongin_imagination_forest",
        "type": "place",
        "category": "체험·놀이",
        "genre": "도서관",
        "is_child": True,
