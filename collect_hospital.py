...
AREAS = [
    ...
    # 인천 - 중구/동구가 제물포구로, 중구 영종도 관할분이 영종구로 개편됐는데
    # 이 API엔 예전 이름 데이터도 남아있어서(검단구/서해구 때와 동일 패턴, 확인함:
    # 제물포구 137건/영종구 87건 vs 중구 8건/동구 772건 - 넷 다 0이 아님) 넷 다 조회한다.
    ("인천광역시", "중구"), ("인천광역시", "동구"), ("인천광역시", "제물포구"),
    ("인천광역시", "영종구"), ("인천광역시", "미추홀구"),
